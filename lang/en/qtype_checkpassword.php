...
/**
 * Strings for component 'qtype_checkpassword', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
...
$string['pluginname_link'] = 'question/type/checkpassword';
...
$string['feedbackstrong'] = 'Strong password.';
$string['feedbackweak'] = 'Weak password.';
$string['feedbackmissing'] = 'The following criteria must be met:';
$string['feedbackmissinglength'] = 'at least 8 characters';
$string['feedbackmissinguppercase'] = 'at least one uppercase letter';
$string['feedbackmissinglowercase'] = 'at least one lowercase letter';
$string['feedbackmissingnumber'] = 'at least one number';
$string['feedbackmissingspecialchar'] = 'at least one special character';
