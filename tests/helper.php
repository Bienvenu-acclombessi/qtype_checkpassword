...
/**
 * Test helpers for the checkpassword question type.
 *
...
/**
 * Test helper class for the checkpassword question type.
 *
 * @copyright  2024 Bienvenu ACCLOMBESSI [Gits] bienvenu.acclombessi@gmail.com
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_checkpassword_test_helper extends question_test_helper {
    public function get_test_questions() {
        return array('frogtoad', 'frogonly', 'escapedwildcards');
    }

    /**
     * Makes a checkpassword question with correct ansewer 'frog', partially
     * correct answer 'toad' and defaultmark 1. This question also has a
     * '*' match anything answer.
     * @return qtype_checkpassword_question
     */
    public function make_checkpassword_question_frogtoad() {
        question_bank::load_question_definition_classes('checkpassword');
        $sa = new qtype_checkpassword_question();
        ...
        $sa->qtype = question_bank::get_qtype('checkpassword');

        return $sa;
    }

    /**
     * Gets the question data for a checkpassword question with with correct
     * ansewer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_checkpassword_question_data_frogtoad() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);

        $qdata->qtype = 'checkpassword';
    ...
    /**
     * Gets the question form data for a checkpassword question with with correct
     * answer 'frog', partially correct answer 'toad' and defaultmark 1.
     * This question also has a '*' match anything answer.
     * @return stdClass
     */
    public function get_checkpassword_question_form_data_frogtoad() {
        $form = new stdClass();
    ...
    /**
     * Makes a checkpassword question with just the correct ansewer 'frog', and
     * no other answer matching.
     * @return qtype_checkpassword_question
     */
    public function make_checkpassword_question_frogonly() {
        question_bank::load_question_definition_classes('checkpassword');
        $sa = new qtype_checkpassword_question();
        test_question_maker::initialise_a_question($sa);
        $sa->name = 'Short answer question';
    ...
    /**
     * Gets the question data for a checkpassword questionwith just the correct
     * ansewer 'frog', and no other answer matching.
     * @return stdClass
     */
    public function get_checkpassword_question_data_frogonly() {
        $qdata = new stdClass();
        test_question_maker::initialise_question_data($qdata);
     ...
     * @return qtype_checkpassword_question
     */
    public function make_checkpassword_question_escapedwildcards() {
        question_bank::load_question_definition_classes('checkpassword');
        $sa = new qtype_checkpassword_question();
        test_question_maker::initialise_a_question($sa);
