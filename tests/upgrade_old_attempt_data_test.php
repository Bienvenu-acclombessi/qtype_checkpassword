...
/**
 * Testing the upgrade of checkpassword question attempts.
 *
...
class upgrade_old_attempt_data_test extends \question_attempt_upgrader_test_base {
    ...
    public function test_checkpassword_deferredfeedback_history620(): void {
        $quiz = (object) array(
            'id' => '221',
            'course' => '187',
 ...
 <p>Ignore all sunk costs, ignore all ______ costs, use remaining costs for decision making purposes. </p>',
    ...
    public function test_checkpassword_deferredfeedback_history60(): void {
        $quiz = (object) array(
            'id' => '789',
            'course' => '3500',
    ...
    public function test_checkpassword_deferredfeedback_history3220(): void {
        $quiz = (object) array(
            'id' => '221',
            'course' => '187',
            'name' => 'Practice CTMA04',
