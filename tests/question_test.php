...
use qtype_checkpassword_question;
...
require_once($CFG->dirroot . '/question/type/checkpassword/question.php');
...
class question_test extends \advanced_testcase {
    public function test_compare_string_with_wildcard(): void {
        ...
        $this->assertTrue((bool)qtype_checkpassword_question::compare_string_with_wildcard(
                'Frog', 'Frog', false));
        $this->assertFalse((bool)qtype_checkpassword_question::compare_string_with_wildcard(
                'Frog', 'frog', false));
        $this->assertTrue((bool)qtype_checkpassword_question::compare_string_with_wildcard(
                '   Frog   ', 'Frog', false));
        $this->assertFalse((bool)qtype_checkpassword_question::compare_string_with_wildcard(
    ...
    public function test_is_complete_response(): void {
        $question = \test_question_maker::make_question('checkpassword');
    ...
    public function test_get_correct_response_escapedwildcards(): void {
        $question = \test_question_maker::make_question('checkpassword', 'escapedwildcards');

        $this->assertEquals(array('answer' => 'x*y'), $question->get_correct_response());
    }

    public function test_get_question_summary(): void {
        $sa = \test_question_maker::make_question('checkpassword');
    ...
    public function test_classify_response_no_star(): void {
        $sa = \test_question_maker::make_question('checkpassword', 'frogonly');
        $sa->start_attempt(new question_attempt_step(), 1);
