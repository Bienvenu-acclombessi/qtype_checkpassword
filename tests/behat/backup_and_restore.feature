...
Feature: Test duplicating a quiz containing a Short answer question
  ...
  Background:
    ...
    And the following "questions" exist:
      ...
      | Test questions   | checkpassword | checkpassword-001 | frogtoad |
  ...
  Scenario: Backup and restore a course containing a Short answer question
    ...
    And I choose "Edit question" action for "checkpassword-001" in the question bank
    Then the following fields match these values:
      | Question name        | checkpassword-001                                   |
