...
namespace qtype_checkpassword;

use qtype_checkpassword;
use qtype_checkpassword_edit_form;
use question_possible_response;

defined('MOODLE_INTERNAL') || die();

global $CFG;
require_once($CFG->dirroot . '/question/type/checkpassword/questiontype.php');
require_once($CFG->dirroot . '/question/engine/tests/helpers.php');
require_once($CFG->dirroot . '/question/type/edit_question_form.php');
require_once($CFG->dirroot . '/question/type/checkpassword/edit_checkpassword_form.php');

/**
 * Unit tests for the checkpassword question type class.
 *
 ...
 * @covers \qtype_checkpassword
 */
class question_type_test extends \advanced_testcase {
    protected $qtype;

    protected function setUp(): void {
        $this->qtype = new qtype_checkpassword();
    }
    ...
    protected function get_test_question_data() {
        return \test_question_maker::get_question_data('checkpassword');
    }

    public function test_name(): void {
        $this->assertEquals($this->qtype->name(), 'checkpassword');
    }
    ...
    public function test_get_random_guess_score(): void {
        $q = \test_question_maker::get_question_data('checkpassword');
    ...
    public function test_get_possible_responses_no_star(): void {
        $q = \test_question_maker::get_question_data('checkpassword', 'frogonly');
    ...
    public function test_question_saving_frogtoad(): void {
        ...
        $questiondata = \test_question_maker::get_question_data('checkpassword');
        $formdata = \test_question_maker::get_question_form_data('checkpassword');

        $generator = $this->getDataGenerator()->get_plugin_generator('core_question');
        $cat = $generator->create_question_category(array());

        $formdata->category = "{$cat->id},{$cat->contextid}";
        qtype_checkpassword_edit_form::mock_submit((array)$formdata);

        $form = \qtype_checkpassword_test_helper::get_question_editing_form($cat, $questiondata);
